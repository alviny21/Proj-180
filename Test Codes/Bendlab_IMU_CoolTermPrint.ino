...
//  Serial.write(27); Serial.print("[2J");  // Clear entire screen
// Serial.write(27); Serial.print("[H");   // Move cursor to top-left corner
  ...
  Serial.print("Temp (C): ");  // No degree symbol
  ...
  for (int i = 0; i < device_count; i++) {
    ...
    Serial.print(i);
    Serial.print(": ");
    Serial.print(ang[0], 2);  // Print raw values only
    Serial.print(", ");
